...
public class Main {
    ...
    public static void main(String[] args) {
	    // todo implement, will manage what domains are scanned
    }
    
    public static String getInstancePublicIp() {
        return null;// Should not cache unless used extensively.
    }//                Though IP is not expected to change.
}
